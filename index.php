	...
	<body>
		...
		<th>
			<div class="linecircle">
				...
				<circle cx="20" cy="30" r="20" fill="#53c2a7"/>
				</svg>
				<svg width="320" height="90">
				<circle cx="75" cy="60" r="30" fill="#379981"/>
				</svg>
		...
		<th>
			<div class="circlerectangle">
				...
				<circle cx="100" cy="50" r="25" fill="#d90000"/>
				</svg>
				<svg width="320" height="200" style="position: absolute;">
				<circle cx="100" cy="150" r="25" fill="#d90000"/>
				</svg>
				<svg width="320" height="300" style="position: absolute;">
				<circle cx="100" cy="250" r="25" fill="#d90000"/>
				</svg>
		...
		<th>
			<div class="polylinecircle">
				<svg width="320" height="90" style="position: absolute;">
				<circle cx="100" cy="50" r="25" fill="#006366"/>
				</svg>
				<svg width="320" height="200" style="position: absolute;">
				<circle cx="100" cy="150" r="25" fill="#006366"/>
				</svg>
				<svg width="320" height="300" style="position: absolute;">
				<circle cx="100" cy="250" r="25" fill="#006366"/>
				</svg>
				<svg height="50" style="margin-top: 20px;">
